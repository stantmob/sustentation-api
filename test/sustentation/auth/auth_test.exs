defmodule Sustentation.AuthTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{encrypted_password: "some encrypted_password", login: "some login"}
    @update_attrs %{encrypted_password: "some updated encrypted_password", login: "some updated login"}
